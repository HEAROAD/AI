...
def analyze_voice(file_path):
    ...
    if pitch_category == "높은 피치" and speed_category == "빠른 속도" and spectral_category == "밝은 목소리":
        ...
        character = "명랑한 새"
    elif pitch_category == "낮은 피치" and volume_category == "낮은 음량" and spectral_category == "어두운 목소리":
        character = "고요한 곰"
    elif frequency_category == "저음" and spectral_category == "어두운 목소리":
        character = "중후한 사자"
    elif pitch_category == "낮은 피치" and speed_category == "보통 속도" and spectral_category == "어두운 목소리":
        character = "개구리"
    else:
        character = "평범한 고양이"
